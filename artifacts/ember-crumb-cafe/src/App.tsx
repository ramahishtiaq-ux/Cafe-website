...
function Home() {
  ...
  const menuItems = [
    ...
    { type: 'bakes', name: 'Twelve-hour sourdough', detail: 'cultured butter, sea salt', price: '$8', image: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=800&q=80' },
